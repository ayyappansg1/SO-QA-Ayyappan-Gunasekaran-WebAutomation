...
//	}
	...
	public void selectParticularProductAndClickPriceButton(By elements, WebDriver driver,String expectedProduct) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(waitSeconds));
		...
		for(WebElement element:allElements){
			if(element.getText().contains(expectedProduct)){
				element.findElement(By.xpath("following::div[@class='pricebar']")).click();
				break;
			}
		}
	}
